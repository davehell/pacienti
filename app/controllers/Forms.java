...
public class Forms extends Application {
  ...
  public static void index(String typ, @As("dd.MM.yyyy") Date datumOd, @As("dd.MM.yyyy") Date datumDo, Long vysetreni, Long lekar) {
    ...
    //datumy nezadány - zobrazí se formulář s kolonkami datum od, do a typem vyšetření
    if(datumOd == null && datumDo == null) { 
      datumOd = new Date();
      datumDo = new Date(); //zde se pouze vkládá datum do kalendáře, proto se nemusí nastavovat čas na 23:59:59
